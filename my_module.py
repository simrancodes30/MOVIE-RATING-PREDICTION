...
def predict_movie_rating(movie_data, model, label_encoders):
    user_movie_features = [
...
def main():
    file_path = "Movie_Rating_Prediction\IMDbMoviesIndia.csv"
    data = load_data(file_path)
    model, label_encoders = preprocess_data(data)
